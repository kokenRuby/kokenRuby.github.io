...
```bash
$ rake db:create # SQLでやったデータベースを作る処理です. わざわざmysqlに入って create database sample とかやる必要ないんです railsスゴイ
$ rails s -b 0.0.0.0
```
...
### それ **Railsでは、何かしらの処理を実装する場合、「Routing => Controller => View」の流れで開発をする**ということです
...
### ここでちょっと app/controllers/home_controller.rb をみてみてください
...
### controller内で変数を宣言して色々やることができます. 
...
### 打ち込みおわったら実行しましょう. 以下のコマンドを実行すればokです

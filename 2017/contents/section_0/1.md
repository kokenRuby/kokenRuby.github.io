...
* [Vagrantfile](https://kokenstudy.github.io/2017/assets/vagrant_files/Vagrantfile)
### vagrantで用いる設定ファイルです

### 以下の二つのファイルはどちらか好きな方をダウンロードしてください

#### 自分で環境構築をしたい方はこちら
* [package.box](https://kokenstudy.github.io/2017/assets/vagrant_files/package.box)
* [proxy_settings.sh](https://kokenstudy.github.io/2017/assets/vagrant_files/proxy_settings.sh)


#### 環境構築はせず、すぐにRubyの文法に入りたい方はこちら
* [package_complete.box](https://kokenstudy.github.io/2017/assets/vagrant_files/package_complete.box)
